...
export default function PlaybackControls({
  ...
  return (
    <div className="glass-card rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 border border-white/10 shadow-2xl">
      {/* Playback Buttons */}
      <div className="flex items-center gap-2">
        <button
          ...
          title="Reset"
          disabled={disabled}
          className="p-2.5 rounded-xl bg-zinc-900 text-zinc-300 border border-white/10 hover:border-white/30 hover:text-white disabled:opacity-40 transition-all"
        >
        ...
        <button
          ...
          className="p-2.5 rounded-xl bg-zinc-900 text-zinc-300 border border-white/10 hover:border-white/30 hover:text-white disabled:opacity-30 transition-all"
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-display font-bold text-sm transition-all duration-200 shadow-md ${
            isPlaying
      ...
      <div className="flex-1 w-full flex items-center gap-3 px-2">
        <span className="text-xs font-mono text-zinc-400 min-w-[55px]">
        ...
        <div className="relative flex-1 flex items-center">
          <input
            ...
            className="w-full h-1.5 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-white disabled:opacity-40"
          />
          <div 
            className="absolute left-0 top-1/2 -translate-y-1/2 h-1.5 bg-white rounded-lg pointer-events-none transition-all duration-75"
