  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-5 border border-white/10 space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-xl font-display font-black text-white">Queue (FIFO - First In, First Out)</h2>
          </div>
      ...
      <div className="glass-card rounded-2xl p-8 border border-white/10 flex flex-col items-center justify-center min-h-[320px] space-y-6">
        ...
        <div className="w-full max-w-4xl min-h-[110px] p-3 rounded-2xl border-t-2 border-b-2 border-dashed border-white/20 bg-zinc-950/90 flex items-center gap-3 overflow-x-auto shadow-inner">
          {isEmpty ? (
            ...
            queue.map((val, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {isFront && (
                    <span className="absolute -top-3 text-[8px] uppercase tracking-wider px-1.5 py-0.2 bg-rose-500 text-white font-bold rounded">
                      FRONT
                    </span>
                  )}
                  {isRear && (
                    <span className="absolute -bottom-3 text-[8px] uppercase tracking-wider px-1.5 py-0.2 bg-emerald-500 text-white font-bold rounded">
                      REAR
                    </span>
                  )}
                </div>
